...
public interface LigneCommandeRepository extends JpaRepository<LigneCommande, Long> {
    ...
    //
    //Elle renvoie donc un tableau de valeurs par ligne : [produitId, nom, totalVendu].
    //
    //Spring Data ne peut pas automatiquement convertir ce résultat en objet Produit car Produit n’a pas de champ totalVendu.
