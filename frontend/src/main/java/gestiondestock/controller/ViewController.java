...
public class ViewController {
    ...
    @FXML
    private javafx.scene.control.Button profileMenuBtn;
    @FXML
    ...
    public void initialize() {
        ...
        boolean isAdmin = role != null
                && (role.equalsIgnoreCase("ADMIN") || role.equalsIgnoreCase("ROLE_ADMIN") || role.contains("ADMIN"));
        if (sidebar != null) {
            sidebar.setVisible(isAdmin);
            sidebar.setManaged(isAdmin);
        }
        if (topbar != null) {
            topbar.setVisible(isAdmin);
            topbar.setManaged(isAdmin);
        }
    ...
    @FXML
    public void openDashboard(ActionEvent e) {
        loadContent("dashboard");
    }

    @FXML
    public void openProducts(ActionEvent e) {
        loadContent("products");
    }

    // had ster dyal mouad 3endakum chi wahed y9isso
    @FXML
    public void openOrders(ActionEvent e) {
        loadContent("GestionDeCommande");
    }

    @FXML
    public void openGestionDeCommande(ActionEvent e) {
        loadContent("GestionDeCommande");
    }

    // hani kan3lemkum
    @FXML
    public void openClients(ActionEvent e) {
        loadContent("clients");
    }

    @FXML
    public void openSuppliers(ActionEvent e) {
        loadContent("suppliers");
    }

    @FXML
    public void openAlerts(ActionEvent e) {
        loadContent("alerts");
    }
