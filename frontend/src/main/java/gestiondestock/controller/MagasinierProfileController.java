...
import gestiondestock.service.MagasinierProfileService;
...
public class MagasinierProfileController {
    ...
    private static final Logger LOGGER = Logger.getLogger(MagasinierProfileController.class.getName());
    ...
    private final MagasinierProfileService magasinierProfileService = new MagasinierProfileService();
    private MagasinierProfileModel currentProfile;
    ...
    private void loadProfile() {
        try {
            ...
            currentProfile = magasinierProfileService.getMyProfile();
    ...
    private void handleEditProfile() {
        Dialog<MagasinierProfileModel> dialog = createEditProfileDialog();
        Optional<MagasinierProfileModel> result = dialog.showAndWait();

        result.ifPresent(profile -> {
            try {
                // Appeler le service pour mettre à jour le profil
                MagasinierProfileModel updatedProfile = magasinierProfileService.updateProfile(profile);
    ...
    private void handleChangePassword() {
        ...
        result.ifPresent(passwords -> {
            try {
                ...
                magasinierProfileService.changePassword(oldPassword, newPassword);
    ...
    private Dialog<MagasinierProfileModel> createEditProfileDialog() {
        Dialog<MagasinierProfileModel> dialog = new Dialog<>();
        ...
        dialog.setResultConverter(dialogButton -> {
            if (dialogButton == saveButtonType) {
                if (!validateProfileFields(txtNom, txtPrenom, txtTelephone)) {
                    return null;
                }
                MagasinierProfileModel newProfile = new MagasinierProfileModel();
    ...
    private boolean validateProfileFields(TextField txtNom, TextField txtPrenom, TextField txtTelephone) {
