...
public class AdminProfileService {
    ...
    public AdminProfileModel getMyProfile() throws Exception {
        ...
        return gson.fromJson(dataJson, AdminProfileModel.class);
    }

    // Mettre à jour le profil
    public AdminProfileModel updateProfile(AdminProfileModel profile) throws Exception {
        URL url = new URL(BASE_URL + "/profile");
        HttpURLConnection conn = (HttpURLConnection) url.openConnection();
